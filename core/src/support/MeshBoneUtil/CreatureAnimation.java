...
public class CreatureAnimation {
    ...
    public CreatureAnimation(support.CreatureFlatDataJava.animation animFlat,
                             String name_in)
    {
    	StartInit(name_in);
	...
	public void LoadFromDataFlat(String name_in,
                                 support.CreatureFlatDataJava.animation animFlat)
	{
		support.CreatureFlatDataJava.animationClip flat_clip = null;
        ...
        Tuple<Integer, Integer> start_end_times = CreatureModuleUtils.GetStartEndTimesFlat(flat_clip.bones());
		//CreatureModuleUtils.GetStartEndTimes(json_clip, "bones");
        start_time = start_end_times.x;
        end_time = start_end_times.y;
