...
public class Creature {
    ...
    public HashMap<String, Vector<CreatureUVSwapPacket>> uv_swap_packets;
    ...
    public Creature(support.CreatureFlatDataJava.rootData flatRoot)
    {
    	StartInit();
    ...
    private void StartInit()
    {
		...
		uv_swap_packets = new  HashMap<String, Vector<CreatureUVSwapPacket>>();
    ...
    public void LoadFromDataFlat(support.CreatureFlatDataJava.rootData flatRoot)
    {
    	support.CreatureFlatDataJava.mesh flat_mesh = flatRoot.dataMesh();
    	support.CreatureFlatDataJava.skeleton flat_skeleton = flatRoot.dataSkeleton();
        ...
        */
        ...
        // Fill up uv swap packets
        support.CreatureFlatDataJava.uvSwapItemHolder flat_uv_swap_item_holder = flatRoot.dataUvSwapItem();
        uv_swap_packets = CreatureModuleUtils.FillSwapUvPacketMapFlat(flat_uv_swap_item_holder);
        
        // Load Anchor Points
        support.CreatureFlatDataJava.anchorPointsHolder flat_anchor_holder = flatRoot.dataAnchorPoints();
